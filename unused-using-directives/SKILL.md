...
description: Always use this when C# files contain unused using directives that generate noise, warnings, or unnecessary imports - documents how to detect, report and safely remove unused using blocks.
---
